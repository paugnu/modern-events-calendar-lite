...
if (!class_exists('CS_REST_DoNothingSerialiser')) {
    ...
    public function __construct() {}
        public function get_type() { return 'do_nothing'; }
        public function serialise($data) { return $data; }
        public function deserialise($text) {
            $data = json_decode($text);
            return $data ?? $text;
        }
        public function check_encoding($data) { return $data; }
    }
}
...
if (!class_exists('CS_REST_NativeJsonSerialiser')) {
    class CS_REST_NativeJsonSerialiser extends CS_REST_BaseSerialiser {
        ...
        public function deserialise($text) {
            ...
            return $this->strip_surrounding_quotes($data ?? $text);
        }
