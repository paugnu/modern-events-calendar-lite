...
$get_direction = (isset($settings['google_maps_get_direction_status']) and in_array($settings['google_maps_get_direction_status'], [0,1,2])) ? $settings['google_maps_get_direction_status'] : 0;
...
$current_event = (isset($map_data->events[$event_id]) ? [$map_data->events[$event_id]] : []);
