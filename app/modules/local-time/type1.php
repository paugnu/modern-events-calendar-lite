...
<div class="mec-local-time-details" id="mec_local_time_details">
    ...
    <div class="mec-local-date"><?php echo sprintf(__('Date: %s', 'modern-events-calendar-lite'), $this->date_label(['date'=>date('Y-m-d', $user_start_time)], ['date'=>date('Y-m-d', $user_end_time)], $date_format1)); ?></div>
