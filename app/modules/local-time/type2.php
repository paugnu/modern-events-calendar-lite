...
if(is_array($MEC_Events_dates_localtime[$MEC_Shortcode_id][$event_id]))
{
    ...
    {
        $dates = ($MEC_Events_dates_localtime[$MEC_Shortcode_id][$event_id][$k] ?? NULL);
...
<div class="mec-localtime-details" id="mec_localtime_details">
    <div class="mec-localtime-wrap">
        ...
        <div class="mec-localdate"><?php echo sprintf(__('%s |', 'modern-events-calendar-lite'), $this->date_label(['date'=>date('Y-m-d', $user_start_time)], ['date'=>date('Y-m-d', $user_end_time)], $date_format1)); ?></div>
