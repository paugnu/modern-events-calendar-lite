...
class Carbon extends DateTime implements JsonSerializable, \Stringable
{
    ...
    public function __get($name)
    {
        ...
        switch (true) {
            case isset($formats[$name]):
                $format = $formats[$name];
                $method = str_starts_with($format, '%') ? 'formatLocalized' : 'format';
    ...
    public function formatLocalized($format)
    {
        ...
        return static::$utf8 ? mb_convert_encoding($formatted, 'UTF-8', 'ISO-8859-1') : $formatted;
    }
    ...
    public function isSameQuarter($date = null, $ofSameYear = null)
    {
        ...
        $ofSameYear ??= static::shouldCompareYearWithMonth();
    ...
    public function diffFiltered(CarbonInterval $ci, Closure $callback, $date = null, $absolute = true)
    {
        ...
        $values = array_filter(iterator_to_array($period), fn($date) => call_user_func($callback, Carbon::instance($date)));
    ...
    {
        return $this->diffInDaysFiltered(fn(Carbon $date) => $date->isWeekday(), $date, $absolute);
    }
    ...
    {
        return $this->diffInDaysFiltered(fn(Carbon $date) => $date->isWeekend(), $date, $absolute);
    }
    ...
    public function jsonSerialize()
    {
        ...
        return call_user_func(fn() => get_object_vars($carbon));
    }
    ...
    public static function __callStatic($method, $parameters)
    {
        ...
        if (static::$localMacros[$method] instanceof Closure && method_exists('Closure', 'bind')) {
            return call_user_func_array(Closure::bind(static::$localMacros[$method], null, static::class), $parameters);
        }
