...
class Translator implements TranslatorInterface, TranslatorBagInterface
{
     ...
     */
    public function __construct(?string $locale, ?MessageFormatterInterface $formatter = null, private readonly ?string $cacheDir = null, private readonly bool $debug = false)
    {
    ...
    public function transChoice($id, $number, array $parameters = [], $domain = null, $locale = null)
    {
        if (!$this->formatter instanceof ChoiceMessageFormatterInterface) {
            throw new LogicException(sprintf('The formatter "%s" does not support plural translations.', $this->formatter::class));
        }
